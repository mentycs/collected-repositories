...
Let errors bubble up and fail fast and loud with proper error messages, we are early in development and want to make sure we catch the errors so we can implement fixes.
...
[Some example form your codebase]
